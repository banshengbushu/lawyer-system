        ...
        <div className="login-container">
            <div className="login-container__sign-in">
                ...
                <input onChange={e => setMobile(e.target.value)} placeholder="Mobile"
                       className="login__email login--input" type="text"/>
                <input onChange={e => setPassword(e.target.value)} placeholder="Password"
                       className="login__password login--input" type="text"/>
                <button onClick={() => onSubmit()} className="login-sign-in__button">SIGN IN</button>
            </div>
